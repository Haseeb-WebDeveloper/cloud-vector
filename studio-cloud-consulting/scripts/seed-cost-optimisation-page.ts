...
async function seedCostOptimisationPage() {
  ...
  const heroSection = {
    mainHeading:
      'Stop Overpaying AWS Unlock <span className="text-primary"> Savings Up to 68%</span>',
    ...
    heroImagePath: '/hero-images/Cost Optimisation.png',
  }
  ...
  const industryFactsData = [
    {
      ...
      imagePath:
        '/Cloud Spending & Waste is Escalating Fast/Gartner (How to Identify and Reduce Public Cloud Waste 2024).png',
    },
    {
      ...
      imagePath:
        "/Cloud Spending & Waste is Escalating Fast/McKinsey Company (Cloud's trillion-dollar prize is up for grabs. Report).png",
    },
    {
      ...
      imagePath:
        '/Cloud Spending & Waste is Escalating Fast/Everest Group (Cloud Waste Survey 2024).png',
    },
    {
      ...
      imagePath:
        '/Cloud Spending & Waste is Escalating Fast/Omdia (State of Cloud Usage Optimization 2024).jpg',
    },
    {
      ...
      imagePath:
        '/Cloud Spending & Waste is Escalating Fast/McKinsey  Company (Everything Is Better as Code Using FinOps to Manage Cloud Costs 2025).jpg',
    },
  ]
  ...
  const ourApproachSection = {
    ...
    subtitle:
      'Our method optimizes efficiency at every level so that your savings scale with your business, not your costs.',
  ...
  const costOptimisationPageDoc: any = {
    ...
    metaDescription:
      "Stop overpaying AWS. Unlock savings up to 68% with Cloud Victor's all-in-one cloud cost optimisation solution.",
  }
  ...
  try {
    ...
    console.log('\n📋 Summary:')
    console.log(
      `  - Hero section: ✅ (${heroSection.animatedTexts.length} animated texts, ${heroSection.ctaButtons.length} CTA buttons)`,
    )
    console.log(`  - Client section: ✅ (${clientSection.stats.length} stats)`)
    ...
    console.log(
      `  - Get Started section: ✅ (${getStartedSection.chips.length} chips, ${getStartedSection.ctaButtons.length} CTA buttons)`,
    )
