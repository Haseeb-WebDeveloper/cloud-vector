...
const AnimatedSections: React.FC = () => {
  ...
  const stepImagesContainerRef = useRef<HTMLDivElement>(null);
  ...
  const offers: OfferData[] = [
    ...
    },
    {
      ...
      features: [
        ...
        {
          icon: <Clock size={20} />,
          text: "Fast Fixes → Rightsize, Reconfigure, Smarter Purchase Plans delivered in a few days.",
        },
        {
          icon: <BadgeCheck size={20} />,
          text: "One-time Outcome-based Fees → No subscription.",
        },
        {
    ...
    },
    {
      ...
      features: [
        {
          icon: <Rocket size={20} />,
          text: "Tailored Launchpad → Cloud designs aligned with your performance, security, and compliance needs.",
        },
        {
          icon: <Check size={20} />,
          text: "Cost-Efficient, Security-Compliant, Performant, Resilient, and Scalable By Design",
        },
        {
          icon: <Server size={20} />,
    ...
    },
    {
      ...
      features: [
        ...
        {
          icon: <Rocket size={20} />,
          text: "Blue/Green Deployments → Automated Rollbacks.",
        },
        {
          icon: <ShieldCheck size={20} />,
  ...
  // Images for every offer/step in the steps row
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Pin the left column (now the step images row w/center circle)
      ...
      // Animate offers (opacity as usual)
      ...
      // Horizontal scroll for steps row
      if (stepImagesContainerRef.current) {
        const container = stepImagesContainerRef.current;
        const totalWidth =
        ...
        ScrollTrigger.create({
          ...
          anticipatePin: 1,
          onUpdate: (self) => {
            // Instead of direct mapping, use natural scroll progression
      ...
      // Stats cards animation (bidirectional)
      ...
      <section ref={sectionRef} className="min-h-screen py-20 ">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            {/* Left Column - Horizontal Step Images Row with Central Circle */}
            <div
              ref={leftColumnRef}
            ...
            >
              <div className="relative flex items-center justify-center w-full h-full">
                ...
                <div
                  ref={stepImagesContainerRef}
                  className="relative flex items-center gap-12 h-full w-full overflow-hidden"
                  style={{ willChange: "transform" }}
                >
                  {stepImageIndices.map((step, i) => (
                    <div
                      key={step}
                      className={`flex-shrink-0 flex items-center justify-center relative transition-opacity duration-500 ${
                  ...
                  {/* Central Circle Image Overlayed and Centered */}
                  <div
                    ref={circleImageRef}
                    className="absolute left-1/2 top-1/2 z-20 object-contain w-[20rem] h-[20rem] -translate-x-1/2 -translate-y-1/2 pointer-events-none"
                  >
                    <Image
