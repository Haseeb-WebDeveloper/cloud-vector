        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          ...
          <SpotlightCard className="h-full rounded-3xl border border-neutral-800 bg-neutral-900 overflow-hidden p-8">
            <div className="flex flex-col gap-6 justify-between h-full">
              ...
              <div>
                <button className="cursor-pointer w-full bg-gradient-to-r from-[#FF9900]/90 to-[#E85409]/90 hover:from-[#FF9900] hover:to-[#E85409] px-6 py-3 rounded-lg font-medium hover:bg-foreground/10 transition-colors">
          ...
          <SpotlightCard className="h-full rounded-3xl border border-neutral-800 bg-neutral-900 overflow-hidden p-8">
            <div className="flex flex-col gap-6 justify-between h-full">
              ...
              <div>
                <button className="cursor-pointer w-full bg-gradient-to-r from-[#FF9900]/90 to-[#E85409]/90 hover:from-[#FF9900]  px-6 py-3 rounded-lg font-medium  transition-all duration-300">
                  Start Saving Today.
                </button>
              </div>
            </div>
