...
export type RollingTextWrapperProps = {
  texts: string[];
  duration?: number;
  interval?: number;
  className?: string;
...
export function RollingTextWrapper({
  texts,
  duration = 0.6,
  interval = 2000,
  className,
  ...
  }, [texts.length, interval, duration]);

  const handleAnimationComplete = () => {
    // This will be called when the enter animation completes
  };
